...
public class Updater
{
    ...
    private Updater.UpdateResult result = Updater.UpdateResult.NOT_READY; // Used for determining the outcome of the update process
    // Strings for reading RSS
    private static final String TITLE = "title";
    private static final String LINK = "link";
    private static final String ITEM = "item";

    // Runnable for calling back to the plugin
    ...
    public enum UpdateResult
    {
        ...
        NOT_READY,
        /**
         * The updater is downloading an update.
         */
        DOWNLOADING,
    }
     ...
     */
    public Updater(Plugin plugin, String slug, File file, UpdateType type, boolean announce, Runnable callback)
    {
        this.plugin = plugin;
        this.type = type;
        ...
        catch (MalformedURLException ex)
        {
            ...
            if ( callback != null )
                plugin.getServer().getScheduler().scheduleSyncDelayedTask(plugin, callback);
        }
    ...
    /**
     * Get the result of the update process, but don't block if it isn't finished if block is false.
     */
    public UpdateResult getResult(boolean block)
    {
        if ( block )
            waitForThread();
    ...
    private void saveFile(File folder, String file, String u)
    {
        ...
        try
        {
            ...
            result = Updater.UpdateResult.SUCCESS;
            if ( callback != null )
                plugin.getServer().getScheduler().scheduleSyncDelayedTask(plugin, callback);
        }
        catch (Exception ex)
